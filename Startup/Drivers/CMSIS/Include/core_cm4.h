...
#include "cmsis_version.h"define __CM4_CMSIS_VERSION_MAIN  (__CM_CMSIS_VERSION_MAIN)              /*!< \deprecated [31:16] CMSIS HAL main version */
...
#include "cmsis_compiler.h"               /"cmsis_compiler.h"plusplus
}
#endif
